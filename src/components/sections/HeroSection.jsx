...
export default function HeroSection() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center pt-[80px] pb-16 bg-dots isolate relative px-3">
            ...
            <Wrapper className="flex flex-col items-center justify-center gap-y-8 px-4">
                ...
                <h1 className="font-bold text-4xl md:text-[3.8rem] text-center max-w-4xl bg-linear-to-br from-neutral-900 dark:from-neutral-400 via-gray-600 dark:via-neutral-200 to-neutral-800 bg-clip-text text-transparent">
