...
export default function ResetPasswordForm({ errorCode, errorDescription }) {
            ...
            <Card className="p-3 md:p-5 w-full max-w-[400px]">
                ...
                >
                    ...
                    {(errorCode || errorDescription) && (
                        <div
                            className={`rounded-sm text-sm border p-3 mt-2 border-destructive/40 text-destructive bg-destructive/10`}
                        >
                            <p className="capitalize">{errorCode || ""}</p>
