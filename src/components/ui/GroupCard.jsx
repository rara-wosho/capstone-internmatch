...
export default function GroupCard() {
    return (
        <div className="border shadow-xs bg-card rounded-lg hover:bg-accent/20 dark:hover:bg-accent/50 hover:border-accent-foreground/40 transition-colors flex items-center group">
            <Link
