...
export default function GroupCard() {
    return (
        <div className="border bg-card rounded-sm hover:bg-accent/20 dark:hover:bg-accent/50 hover:border-accent-foreground/40 transition-colors flex items-center group">
            <Link
